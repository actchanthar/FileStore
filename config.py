...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "839611")
APP_ID = int(os.environ.get("APP_ID", "2303"))
API_HASH = os.environ.get("API_HASH", "30b5ce6ea2bbbbc3fe5368bb")

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002999551636"))
OWNER = os.environ.get("OWNER", "When_the_night_falls_my_soul")
