...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1001610001670"))
#put 0 to disable
...
START_PIC = os.environ.get("START_PIC", "https://i.imghippo.com/files/ZtkE2660GE.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.imghippo.com/files/fgmj5944fE.jpg")

# Turn this feature on or off using True or False put value inside  ""
# TRUE for yes FALSE if no 
TOKEN = False if os.environ.get('TOKEN', "False") == "True" else True
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "5115691197 6273945163").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @actanimemm</b>")
...
USER_REPLY_TEXT = "ʙᴀᴋᴋᴀ ! ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴍʏ ꜱᴇɴᴘᴀɪ!! ❌Bot ကိုစာပို့လို့မရပါဘူးနော်😅။ရုပ်ရှင်သီးသန့်ပဲပို့ပေးတာပါ။ "
