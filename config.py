...
APP_ID = int(os.environ.get("APP_ID", "22649259")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "545169590ffbfe0bf8bade55e3a1cfde") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002767870571")) #Your db channel Id
